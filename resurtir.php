...
if ($cnn1->connect_error) {
  ...
  session_start();
   ...
   if(isset($_GET['destruir'])){
    unset($_SESSION['renglonesResurtir']);
  }
    ...
    <form method="GET" action="#" >
        <div class="row col-sm-offset-5 col-sm-4 " >
            <h4><label style="text-align: center;">RESURTIR</label></h4>
        </div>
            ...
            <div class="row col-sm-offset-5 col-sm-4 ">
                <div><label style='align: center;'>DETALLES DE RESURTIDO</label></div>
            </div>
            ...
            <div class="col-sm-offset-1 col-sm-10" style="margin-top: 5px; overflow: auto; height: 300px;">
                <table class='table table-bordered' style='width: 100%;'>                            
                    <tr style="background: #085f63; color: white;">
            ...
            <?php
                if(isset($_SESSION['renglonesResurtir'])){//Si la variable de session, ya existe si no pues la crea
                    //
                }else{
                    $_SESSION['renglonesResurtir']="";
                }

                    if(isset($_GET['buscarProducto'])){//El producto va a ser buscado en la cookie de producto y agregado a la variable de session['renglonesResurtir'] con status=0;
                        $i=0;
                        ...
                        if($posicion>-1){//Si si encontro el producto
                            if($_SESSION['renglonesResurtir']!=""){//Sí la variable de session es diferente de vacio, despues que ya sepa que si tiene algo, entonces debo buscar que no exista el producto en la variable de session.
                                $elementosProducto=explode("$",$_COOKIE['cookieProductos'.$posicion]);
                                $i=0;
                                $elementosProdSession=explode("|",$_SESSION['renglonesResurtir']);
                                ...
                                if($msgProducto==""){//En este if se compara que el msgProducto siga siendo "" si no esta vacio es porque debe mostrar el mensaje
                                     $_SESSION['renglonesResurtir'].=$_COOKIE['cookieProductos'.$posicion]."0$0$0$|";
                                }
                                     
                            }else{//la variable si esta vacia, entonces se le va a agregar su primer elemento
                                $_SESSION['renglonesResurtir'].=$_COOKIE['cookieProductos'.$posicion]."0$0$0$|";//se le agrega la cantidad default 0,el importe 0, el status 0, es decir que no ah sido agregado a la venta
                            }
                        }else{
                ...
                if(isset($_GET['btnAdd'])){
                    ...
                    $_SESSION['renglonesResurtir']=$auxiliar;
                }
                ...
                $total=0;
                $renglonesProdSession=explode("|",$_SESSION['renglonesResurtir']);
                $tamanio=count($renglonesProdSession)-1;
                $i=0;

                //echo "Tamanio: ".$tamanio." renglonesResurtir: ".$_SESSION['renglonesResurtir'];
                while($i<$tamanio){
 ...
 <form method="GET" method="#">
    <input type="submit" name="destruir" value="Cancelar Resurtir" class="btn btn-danger" />
    <input type="submit" name="Guardar" value="Guardar Resurtir" class="btn btn-info" />
</form>


<?php
        //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        //////////ESTE APARTADO ES PARA GUARDAR LOS RESURTIDOS EN LA BASE DE DATOS//////////////////////////////////////////////////////
    ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        if(isset($_GET['Guardar'])){
            ...
            if($cantidad>1){
                ...
                $qry1="insert into resurtir values(null,curdate(), $total);";
                
                $cnn->query($qry1);
                $cve_resurtir=$cnn->insert_id;


                ///////////////////////////////////////////////////////////////////
                ////////insertar los renglones del resurtido/////////////////////
                $j=0;
                while($j<$cantidad){
                    ...
                    if($subElementos[9]==1){
                        ...
                        ///////////SUMA AL RENGLONKARDEX
                        
                        $nuevaExistencia=$subElementos[4]+$cantProd;
                        $qryrenkar="insert into renglonkardex values(null,'R',now(), $cantProd, $nuevaExistencia, $cveKar);";
                        $cnn->query($qryrenkar);

                        $qryxz="insert into renglonresurtir values(null,'$nomProd', $cantProd, $pu, '$cveProd' , $cve_resurtir);";
                ...
                unset($_SESSION['renglonesResurtir']);
                echo "<label style='color: red;' >Resurtido almacenado con éxito :) !!!</label>";
            }else{
