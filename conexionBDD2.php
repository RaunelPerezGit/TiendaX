...
if($salida=="ERROR"){
	...
	if($usuario!=""){
		header("Location:menuprincipal.php?datosProductos=".$datosProductos."&datosClientes=".$datosClientes."&datosProveedor=".$datosProveedor."&datosUsuarios=".$datosUsuarios."&datoskit=".$datoskit."&tienda=2&usuario=".$usuario);
	}else{
		header("Location:login.php");
	}
